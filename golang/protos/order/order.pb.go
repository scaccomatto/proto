...
const file_protos_order_order_proto_rawDesc = "" +
	...
	"\border_id\x18\x01 \x01(\x05R\aorderId2u\n" +
	"\x05Order\x125\n" +
	"\x06Create\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00\x125\n" +
	"\x06Update\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\"\x00B+Z)github.com/scaccomatto/proto/golang/orderb\x06proto3"
...
var file_protos_order_order_proto_depIdxs = []int32{
	...
	0, // 2: Order.Update:input_type -> CreateOrderRequest
	2, // 3: Order.Create:output_type -> CreateOrderResponse
	2, // 4: Order.Update:output_type -> CreateOrderResponse
